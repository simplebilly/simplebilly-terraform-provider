...
var _ resource.Resource = &CustomerGroupResource{}
var _ resource.ResourceWithImportState = &CustomerGroupResource{}
...
func (r *CustomerGroupResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Manages a customer_group resource.",
		Attributes: map[string]schema.Attribute{
		},
	}
}

func (r *CustomerGroupResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *CustomerGroupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	resp.Diagnostics.AddError("Not Supported", "Create is not supported for customer_group")
}
