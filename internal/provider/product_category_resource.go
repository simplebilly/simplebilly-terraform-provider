...
var _ resource.Resource = &ProductCategoryResource{}
var _ resource.ResourceWithImportState = &ProductCategoryResource{}
...
func (r *ProductCategoryResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Manages a product_category resource.",
		Attributes: map[string]schema.Attribute{
		},
	}
}

func (r *ProductCategoryResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ProductCategoryResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	resp.Diagnostics.AddError("Not Supported", "Create is not supported for product_category")
}
