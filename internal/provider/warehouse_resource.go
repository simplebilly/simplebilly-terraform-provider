...
var _ resource.Resource = &WarehouseResource{}
var _ resource.ResourceWithImportState = &WarehouseResource{}
...
func (r *WarehouseResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Manages a warehouse resource.",
...
func (r *WarehouseResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	resp.Diagnostics.AddError("Not Supported", "Create is not supported for warehouse")
}
