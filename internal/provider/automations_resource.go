...
var _ resource.Resource = &AutomationsResource{}
var _ resource.ResourceWithImportState = &AutomationsResource{}
...
func (r *AutomationsResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Manages a automations resource.",
...
func (r *AutomationsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	resp.Diagnostics.AddError("Not Supported", "Create is not supported for automations")
}
