...
var _ resource.Resource = &TicketMessageResource{}
var _ resource.ResourceWithImportState = &TicketMessageResource{}

func NewTicketMessageResource() resource.Resource {
	return &TicketMessageResource{}
}
...
func (r *TicketMessageResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Manages a ticket_message resource.",
...
func (r *TicketMessageResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	resp.Diagnostics.AddError("Not Supported", "Create is not supported for ticket_message")
}
...
func (r *TicketMessageResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	// No update endpoint available; persist the planned values into state.
	var plan TicketMessageModel
