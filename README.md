...
Official Terraform Provider client for the [SimpleBilly API](https://simplebilly.com/api/docs).
...
> published under [Releases](https://github.com/simplebilly/simplebilly-terraform-provider/releases).

## Installation

The package is published to the Terraform Provider package registry (and to [GitHub Packages](https://github.com/orgs/simplebilly/packages) for public repos — free for public packages).
